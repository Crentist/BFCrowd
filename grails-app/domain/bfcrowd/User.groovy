...
//	static	belongsTo	= []	// tells GORM to cascade commands: e.g., delete this object if the "parent" is deleted.
	...
	static	hasMany		= [myContributions:Contribution, myProjects:Project, skippedRecom:Recommendation, ownedProjects: Project]	// tells GORM to associate other domain objects for a 1-n or n-m mapping
