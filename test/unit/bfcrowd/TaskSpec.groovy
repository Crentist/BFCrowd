...
class TaskSpec extends Specification {
	...
	void "test the addition of one instructionsForm at the beggining of the workflow"() {
		given: "a single populated Task instantiation"
		Project project = new Project(name: "test project", description: "testcription")
		task = new Task()
		...
		task.getInstructionAt(1) == "Do you even?" //get(0) = first element

	}
	
	void "test the addition of one instructionsForm at a given order"() {
		/**
		...
		task.getInstructionAt(1) == "How do you do?" //get(0) = first element
		task.getInstructionAt(2) == "Do you even?"
		...
		task.getInstructionAt(1) == "How do you do?" //get(0) = first element
		task.getInstructionAt(2) == "Do you even?"
		task.getInstructionAt(3) == "Got Milk?"
	}
}
